...
const Home = () => {
  return (
    <div className="w-full border-b-2 border-black h-[40vh] md:h-[70vh] flex flex-row justify-between items-center lg:px-32 bg-[url('./assets/img/home.png')] bg-cover bg-no-repeat">
      <div className="w-full lg:w-2/3 space-y-5 pl-24">
        <div className="hidden sm:block bg-black w-[34rem] h-[265px] bg-opacity-[80%]">
