...
const Store = (props) => {
    return (
        <div>
            <h1 className="text-secondary text-2xl">Name</h1>

            <div className="flex pt-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 13 18" fill="none">
                ...
                <h1 className="pl-3 text-lg">Address</h1>
            </div>
            ...
            <div className="flex pt-3">
                ...
                <h1 className="pl-3 text-lg">Phone</h1>
            </div>
